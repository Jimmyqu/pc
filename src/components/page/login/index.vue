      ...
      <div class="container-reg" v-if="regShow">
        ...
        <el-form  :model="regForm" :rules="regRules" ref="ruleReg">
          ...
          <el-form-item class="login-input reg-code" prop="code">
            ...
            <div class="el-btn">
              <el-button :loading="smsLoading" @click="postCode1">{{smsLoading?smsSec+'s后获取':'获取验证码'}}</el-button>
            </div>
          </el-form-item>
          <el-form-item class="login-input reg-code" prop="code" v-show="false">
            <el-input placeholder="请输入验证码"  v-model="regForm.code" ></el-input>
            <div class="el-btn">
              <el-button :loading="smsLoading" @click="postCode2">{{smsLoading?smsSec+'s后获取':'获取验证码'}}</el-button>
            </div>
          </el-form-item>
    ...
    <div class="container-reg" v-if="forgetShow" >
      ...
      <el-form  :model="ForgotForm" :rules="forgetRules" ref="ruleForgot">
        ...
        <el-form-item class="login-input" prop="repass">
          <el-input placeholder="请再次输入新密码" type="password"  v-model="ForgotForm.repass" ></el-input>
        </el-form-item>
          ...
          return {
            ...
            loginRules: {
              ...
              pass:[
                ...
                {min: 6, max: 100, message: '长度为6-100位的数字或字母', trigger: 'change'}
              ]
            },
            regRules:{
              mobile: [
              ...
              name:[
                ...
                {min: 2, max: 12, message:  '请输入正确的昵称(2-12位)', trigger: 'change'}
              ],
              radio: [
      ...
      methods:{
        ...
        toForgot(val){
          ...
          this.$nextTick(()=>{
            ...
            this.ForgotForm.pass3='';
             this.ForgotForm.repass='';
          })
        ...
        async postCode1(){
          ...
          if(this.regForm.mobile.length===11){
           ...
           let res =await this.$ajax.post('regsendmsg',{
        ...
        async postCode2(){
          console.log(2)
          if(this.ForgotForm.mobile.length===11){
           this.smsLoading =true;
           this.smsSec=30;
            let timer = setInterval(()=>{
              if(this.smsSec>0){
           ...
           let res =await this.$ajax.post('member/getSmsCode',{
        ...
        handlerForgot(){
          ...
          this.$refs['ruleForgot'].validate((valid) => {
            if (valid) {
              if(this.ForgotForm.pass3 === this.ForgotForm.repass ){
                this.$ajax.post('member/resetPassword',{
                  mobile:this.ForgotForm.mobile,
                  sms_code:this.ForgotForm.code,
                  new_password:this.ForgotForm.pass3,
                  new_password_confirmation:this.ForgotForm.repass,
                  user_type:1,
                  type:'pc'
                }).then((res)=>{
                  console.log(res)
